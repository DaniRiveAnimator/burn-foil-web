...
const shaderControlTargets = [
  ...
  "heat.distortionSize",
  "shader.qualityPreset",
  "performance.maxPixelSize",
] as const;
...
export const burnFoilRendererPipeline = {
  ...
  passes: [
    {
      cacheKey: ["source.image", "canvas.size", "performance.maxPixelSize"],
      cost: { dimensions: [], frequency: "discrete", relationship: "constant" },
      id: "source-texture",
      inputs: ["source.image", "canvas.size", "performance.maxPixelSize"],
      invalidatedBy: ["source.image", "canvas.size", "performance.maxPixelSize"],
      kind: "rasterize",
